...
typedef struct
{
	...
	unsigned int		ber_A; 	/*A_Layer Bit Error rate 						(0 ~ 100000)*/
	unsigned int		per_A; 	/*A_Layer Packet Error rate  					(0 ~ 100000)*/
	unsigned int		ber_B; 	/*B_Layer Bit Error rate 						(0 ~ 100000)*/
	unsigned int		per_B; 	/*B_Layer Packet Error rate  					(0 ~ 100000)*/
	unsigned int		ber_C; 	/*C_Layer Bit Error rate 						(0 ~ 100000)*/
	unsigned int		per_C; 	/*C_Layer Packet Error rate  					(0 ~ 100000)*/
...
typedef struct
{
	...
	int ber_A; 	/*Bit Error rate 						(0 ~ 100000)*/
	int per_A;  	/*Packet Error rate  					(0 ~ 100000)*/
	int ber_B; 	/*Bit Error rate 						(0 ~ 100000)*/
	int per_B;  	/*Packet Error rate  					(0 ~ 100000)*/
	int ber_C; 	/*Bit Error rate 						(0 ~ 100000)*/
	int per_C;  	/*Packet Error rate  					(0 ~ 100000)*/
